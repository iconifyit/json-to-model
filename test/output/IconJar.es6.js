...
((global, module, exports) => {
    ...
    class IconJar {
        ...
        constructor(data) {
            ...
            this.instance = 'IconJar@' + generateUUID();
             ...
             * {object}
             */
            this.meta = get( data, 'meta', {} );

            /**
             * {object}
             */
            this.sets = get( data, 'sets', {} );

            /**
             * {object}
             */
            this.licences = get( data, 'licences', {} );

            /**
             * {object}
             */
            this.groups = get( data, 'groups', {} );

            /**
             * {object}
             */
            this.items = get( data, 'items', {} );
